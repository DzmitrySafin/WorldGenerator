...
//source: net.minecraft.world.level.levelgen.structure.structures.StrongholdStructure
public class StrongholdStructure : Structure
{
    public override StructureType StructureType => StructureType.STRONGHOLD;
    ...
    public StrongholdStructure(StructureSettings settings)
        : base(settings)
    {
    }

...
//source: net.minecraft.util.Mth
public class Mth
{
    //private static long UUID_VERSION = 61440L;
    //private static long UUID_VERSION_TYPE_4 = 16384L;
    //private static long UUID_VARIANT = -4611686018427387904L;
    //private static long UUID_VARIANT_2 = long.MinValue;
    ...
    public static float RAD_TO_DEG = 180.0F / (float)Math.PI;
    public static float EPSILON = 1.0E-5F;
    public static float SQRT_OF_TWO = sqrt(2.0F);
    ...
    //private static IRandomSource RANDOM = IRandomSource.createThreadSafe();
    ...
    private static double ONE_SIXTH = 0.16666666666666666;
    //private static int FRAC_EXP = 8;
    private static int LUT_SIZE = 257;
    private static double FRAC_BIAS = BitConverter.Int64BitsToDouble(4805340802404319232L); // double.longBitsToDouble(4805340802404319232L);
    private static double[] ASIN_TAB = new double[LUT_SIZE];
    private static double[] COS_TAB = new double[LUT_SIZE];
    ...
    {
        return SIN[(int)(p_14032_ * SIN_SCALE) & 65535];
    }

    public static float cos(float p_14090_)
    {
        return SIN[(int)(p_14090_ * SIN_SCALE + 16384.0F) & 65535];
    }
    ...
    {
        return (int) Math.Floor((decimal)p_14043_ / p_14044_);
    }

    public static int nextInt(IRandomSource p_216272_, int p_216273_, int p_216274_)
    {
        return p_216273_ >= p_216274_ ? p_216273_ : p_216272_.NextInt(p_216274_ - p_216273_ + 1) + p_216273_;
    }

    public static float nextFloat(IRandomSource p_216268_, float p_216269_, float p_216270_)
    {
        return p_216269_ >= p_216270_ ? p_216269_ : p_216268_.NextFloat() * (p_216270_ - p_216269_) + p_216269_;
    }

    public static double nextDouble(IRandomSource p_216264_, double p_216265_, double p_216266_)
    {
        return p_216265_ >= p_216266_ ? p_216265_ : p_216264_.NextDouble() * (p_216266_ - p_216265_) + p_216265_;
    }

    public static bool equal(float p_14034_, float p_14035_)
    {
        return Math.Abs(p_14035_ - p_14034_) < 1.0E-5F;
    }

    public static bool equal(double p_14083_, double p_14084_)
    {
    ...
    public static int positiveModulo(int p_14101_, int p_14102_)
    {
        ...
        int remainder = p_14101_ % p_14102_;
        if (remainder < 0 && p_14102_ > 0 || remainder > 0 && p_14102_ < 0)
        {
            return remainder + p_14102_;
        }
        return remainder;
    }
    ...
    public static bool isMultipleOf(int p_265754_, int p_265543_)
    {
    ...
    public static int getInt(string p_14060_, int p_14061_)
    {
        ...
        return int.TryParse(p_14060_, out int result) ? result : p_14061_;
    }
    ...
    public static bool isPowerOfTwo(int p_14153_)
    {
    ...
    {
        return getSeed(vec.X, vec.Y, vec.Z);
    }
    ...
    //public static UUID createInsecureUUID(IRandomSource randomSource)
    //{
    //    long i = randomSource.NextLong() & -61441L | 16384L;
    //    long j = randomSource.NextLong() & 4611686018427387903L | long.MinValue;
    //    return new UUID(i, j);
    //}
    ...
    //public static bool rayIntersectsAABB(Vec3 p_144889_, Vec3 p_144890_, AABB p_144891_)
    //{
    ...
    public static double atan2(double p_14137_, double p_14138_)
    {
        ...
        {
            bool flag = p_14137_ < 0.0;
            if (flag)
            {
                p_14137_ = -p_14137_;
            }

            bool flag1 = p_14138_ < 0.0;
            if (flag1)
            {
                p_14138_ = -p_14138_;
            }

            bool flag2 = p_14137_ > p_14138_;
            if (flag2)
            {
                double d1 = p_14138_;
                p_14138_ = p_14137_;
            ...
            int i = (int)BitConverter.DoubleToInt64Bits(d2); // double.doubleToRawLongBits(d2);
    ...
    public static double fastInvSqrt(double p_14194_)
    {
        ...
        long i = BitConverter.DoubleToInt64Bits(p_14194_); // double.doubleToRawLongBits(p_14194_);
        i = 6910469410427058090L - (i >> 1);
        p_14194_ = BitConverter.Int64BitsToDouble(i); // double.longBitsToDouble(i);
        return p_14194_ * (1.5 - d0 * p_14194_ * p_14194_);
    }

    public static float fastInvCubeRoot(float p_14200_)
    {
        int i = BitConverter.ToInt32(BitConverter.GetBytes(p_14200_), 0); // float.floatToIntBits(p_14200_);
        i = 1419967116 - i / 3;
        float f = BitConverter.ToSingle(BitConverter.GetBytes(i)); // float.intBitsToFloat(i);
    ...
    //            break;
    //        default:
    //            throw new Exception("Something went wrong when converting from HSV to RGB. Input was " + p_343715_ + ", " + p_343707_ + ", " + p_342108_);
    //    }
    ...
    public static int binarySearch(int p_14050_, int p_14051_, Predicate<int> p_14052_)
    {
    ...
    {
        return p_144955_ + (2.0 * IRandomSource.Create(floor(p_144955_ * 3000.0)).NextDouble() - 1.0) * 1.0E-7 / 2.0;
    }
    ...
    {
        return (int) -Math.Floor((decimal)-p_184653_ / p_184654_);
    }

    public static int randomBetweenInclusive(IRandomSource p_216288_, int p_216289_, int p_216290_)
    {
        return p_216288_.NextInt(p_216290_ - p_216289_ + 1) + p_216289_;
    }

    public static float randomBetween(IRandomSource p_216284_, float p_216285_, float p_216286_)
    {
        return p_216284_.NextFloat() * (p_216286_ - p_216285_) + p_216285_;
    }

    public static float normal(IRandomSource p_216292_, float p_216293_, float p_216294_)
    {
    ...
    //public static /*IntStream*/IEnumerable<int> outFromOrigin(int p_216296_, int p_216297_, int p_216298_)
    //{
    //    return outFromOrigin(p_216296_, p_216297_, p_216298_, 1);
    //}

    //public static /*IntStream*/IEnumerable<int> outFromOrigin(int p_216251_, int p_216252_, int p_216253_, int p_216254_)
    //{
    //    if (p_216252_ > p_216253_)
    //    {
    //        throw new ArgumentException(string.Format(CultureInfo.InvariantCulture, "upperbound %d expected to be > lowerBound %d", p_216253_, p_216252_));
    //    }
    //    else if (p_216254_ < 1)
    //    {
    //        throw new ArgumentException(string.Format(CultureInfo.InvariantCulture, "steps expected to be >= 1, was %d", p_216254_));
    //    }
    //    else
    //    {
    ...
    //        }, p_216260_-> {
    //            bool flag = p_216260_ <= p_216251_;
    //            int i = Math.Abs(p_216251_ - p_216260_);
    //            bool flag1 = p_216251_ + i + p_216254_ <= p_216253_;
    //            if (!flag || !flag1)
    //            {
    ...
    //public static Quaternion rotationAroundAxis(Vector3f p_311556_, Quaternion p_311192_, Quaternion p_310462_)
    //{
    ...
    //    //float f = Quaternion.Dot(new Quaternion(p_311556_.X, p_311556_.Y, p_311556_.Z, 1.0F), p_311192_);
    //    //p_310462_.X = p_311556_.X * f;
    //    //p_310462_.Y = p_311556_.Y * f;
    //    //p_310462_.Z = p_311556_.Z * f;
    //    //p_310462_.W = p_311192_.W;
    //    //return Quaternion.Normalize(p_310462_);
    //}
